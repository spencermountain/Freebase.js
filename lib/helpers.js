...
var slow=require('/home/spencer/work/slow');
...
fns.settle_params=function(params,method,defaults){
  ...
  if(typeof o.q !="string" || typeof o.options !="object" || typeof o.callback !="function"){return o;}
  //set default options
...
fns.url_lookup=function(q, options, callback){
...
//console.log(fns.singularize("mama cass"));
  ...
  fns.doit_async= function(params) {
    slow.flow(params.q, params.method, params.options, params.callback)
  }
  ...
  fns.http= function(url, options, callback) {
    ...
    if(typeof options=="function"){//handle missing option param
      callback=options;
      options={};
    }
    options=options||{};
